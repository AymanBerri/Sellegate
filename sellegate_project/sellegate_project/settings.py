"""
Django settings for sellegate_project project.
...
SECRET_KEY = 'django-insecure-n((s0+sxf-+#pi6=4v1eh^u(7y$spm(4t6k0ec^u5=!_3p^$g4'
...
ROOT_URLCONF = 'sellegate_project.urls'
...
WSGI_APPLICATION = 'sellegate_project.wsgi.application'

CORS_ALLOW_ALL_ORIGINS = True  # Allows access from all domains
